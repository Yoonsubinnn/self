		...
		<div class="mid"> 
			<div class="div-title">
				...
				<div class="title">
					...
					<div class="title-date">${ list.modifyDate } 게시 날짜 | ${ list.usersId } 작성자</div>
				</div>
		...
		<div class="bottom">
			<div class="bottom-width">
				<div class="bottom-img">
					 <c:if test="${ !empty gList[0].renameName }">
						 <img class="imgg" src="${ contextPath }/resources/uploadFiles/${gList[0].renameName}"> 
					 </c:if>
				</div>
