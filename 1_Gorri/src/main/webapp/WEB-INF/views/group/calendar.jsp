...
<!-- <div style="position:absolute; width:130px; height:600px;border:1px solid black; display:inline-block"> -->

</div>


<div id="schedule" style=" box-shadow: 0 2px 6px rgba(0, 0, 0, 0.9);  position:relative; width:500px;position:absolute; margin-top:17%; height:400px; padding:30px;border:6px solid gold; border-radius:2em; display:none ">
	<div style="text-align:center;"><label  id="scheduleToday" style="font-size: 20px; text-align: center; font-weight: bold;"></label></div>
	<form>
		<br>
		<div style="margin:auto">
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" style="width:200px; border:3px solid gold; border-radius : 30px; height:41px">
			&nbsp;&nbsp;<button class="button">일정 추가</button>
			<br><br>
				<table>
			      <tbody>
			        <tr style="border-bottom:1px solid black;">
			          <td style="text-align:center; height: 30px; border-bottom:3px solid gold; width:1000px;"></td>
			        </tr>
			        <tr>
			          <td style="text-align:center;  height: 50px;border-bottom:3px solid gold; width:1000px;"><b>피크닉 가는 날</b><div style="text-align:right; margin-top:-20px;"><button type="submit" class="deleteButton">삭제</button></div></td>
			        </tr>
			        <tr>
			          <td style="text-align:center;  height: 50px; border-bottom:3px solid gold; width:1000px;"><b>피크닉 가는 날</b><div style="text-align:right; margin-top:-20px;"><button type="submit" class="deleteButton">삭제</button></div></td>
			        </tr>
